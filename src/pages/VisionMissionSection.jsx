    ...
    <section className="bg-[#0C0F1F] text-white py-12 px-6 ">
      ...
      <div className="max-w-7xl mx-auto text-center">
        <p className="text-2xl font-extralight text-gray-400 mx-auto mb-4 p-4">
          Excellence isn’t a goal, it’s our DNA; our relentless pursuit of excellence is the driving force behind our success. Excellence is our legacy, and we
          are proud to carry it forward. Watch the video to see how we are innovating to keep businesses on top of their games.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
          {cardsData.map((card) => (
            <div
              key={card.id}
              className="bg-radial-[at_70%_25%] from-indigo-700 via-slate-900 to-slate-900 to-75%  border-2 border-solid rounded-2xl drop-shadow-cyan-500 border-[#1E2A56] p-6 hover:shadow-lg "
            >
              <img src={card.image} alt={card.title} className="h-80 mx-auto  object-cover mb-6" />
